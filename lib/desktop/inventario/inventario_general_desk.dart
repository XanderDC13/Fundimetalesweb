...
class _InventarioGeneralDeskScreenState
  ...
  Widget _buildTablaGeneral() {
    // ✅ NUEVA RUTA: inventarios/bodega/productos
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        // ✅ OPTIMIZACIÓN: Usar FutureBuilder con método optimizado
                                        ...
                                        onPressed: () async {
                                              ...
                                              await showDialog<bool>(
                                                ...
                                                builder:
                                                    (_) => AlertDialog(
                                                      ...
                                                      content: Text(
                                                        '¿Estás seguro de eliminar "${data['nombre']}" del inventario de Bodega?',
                                                      ),
                                                      actions: [
                                                        TextButton(
                                                          onPressed:
                                          ...
                                          if (confirmar) {
                                            ...
                                            await FirebaseFirestore.instance
                                                ...
                                                .add({
                                                  'accion':
                                                      'Eliminación de Inventario Bodega',
                                                  'detalle':
  ...
  Future<List<Map<String, dynamic>>> _obtenerProductosConNombres(
    ...
    try {
      // ✅ 1. RECOPILAR TODAS LAS REFERENCIAS ÚNICAS
      ...
      // ✅ 2. OBTENER TODOS LOS NOMBRES EN CONSULTAS BATCH (máximo 10 por consulta)
      ...
      if (todasLasReferencias.isNotEmpty) {
        ...
        // ✅ Ejecutar todas las consultas de lotes EN PARALELO
      ...
      print('Error obteniendo productos optimizado: $e');

      // ✅ En caso de error, devolver productos con nombres por defecto
      for (var producto in productos) {
        productosCompletos.add({
          'referencia': producto['referencia'],
          'cantidad': producto['cantidad'],
