import 'package:basefundi/desktop/inventario/tablas/tablainv_pintura_desk.dart';
import 'package:basefundi/settings/navbar_desk.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';

class InventarioPinturaDeskScreen extends StatefulWidget {
  const InventarioPinturaDeskScreen({super.key});

  @override
  State<InventarioPinturaDeskScreen> createState() =>
      _InventarioPinturaDeskScreenState();
}

class _InventarioPinturaDeskScreenState
    extends State<InventarioPinturaDeskScreen>
                                ...
                                onPressed: () async {
                                  ...
                                  if (confirmar) {
                                    ...
                                    await FirebaseFirestore.instance
                                        ...
                                        .add({
                                          'accion':
                                              'Eliminación de Inventario Pintura',
                                          'detalle':
