...
class TablaInvPinturaDeskScreen extends StatefulWidget {
  final String referencia;
  final String nombre;

  const TablaInvPinturaDeskScreen({
    super.key,
  ...
  @override
  State<TablaInvPinturaDeskScreen> createState() =>
      _TablaInvPinturaDeskScreenState();
}

class _TablaInvPinturaDeskScreenState extends State<TablaInvPinturaDeskScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.white, // ✅ Fuerza fondo blanco total
      body: MainDeskLayout(
        child: Container(
          color: Colors.white, // ✅ También fondo blanco interno
          child: Column(
            children: [
              Transform.translate(
              ...
              Expanded(
                child: Transform.translate(
                  offset: const Offset(-0.5, 0), // ✅ Mismo ajuste que cabecera
                  child: _buildTabla(widget.referencia),
                ),
              ),
            ],
          ),
            ...
            child: ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                ...
                minimumSize: const Size(
                  120,
                  36,
                ), // tamaño mínimo para que no quede muy pequeño
      ...
      builder: (context, snapshot) {
        ...
        return LayoutBuilder(
          builder: (context, constraints) {
            ...
            final anchoColumna = totalWidth / 2; // 2 columnas iguales
