...
class _InventarioGeneralDeskScreenState
  ...
  Future<List<Map<String, dynamic>>> _obtenerProductosConNombres(
    ...
    try {
      ...
      print('Error obteniendo productos de bodega optimizado: $e');
    ...
    if (confirmar) {
      try {
        ...
        await FirebaseFirestore.instance.collection('auditoria_general').add({
          'accion': 'Eliminar Cant Inventario Bodega',
          'detalle':
    ...
    if (nuevaCantidad != null && nuevaCantidad != data['cantidad']) {
      try {
        ...
        await FirebaseFirestore.instance.collection('auditoria_general').add({
          ...
          'accion': 'Edición de cantidad de inventario',
          'detalle':
  ...
  Future<void> _exportarPDF() async {
    try {
      ...
      String titulo = 'Inventario Bodega';
      if (_rangoFechas != null) {
        titulo +=
