...
class ReporteVentasDeskScreen extends StatefulWidget {
  const ReporteVentasDeskScreen({super.key});

  @override
  State<ReporteVentasDeskScreen> createState() =>
      _ReporteVentasDeskScreenState();
}

class _ReporteVentasDeskScreenState extends State<ReporteVentasDeskScreen>
                          ...
                          ventasFiltradas.map((venta) {
                            ...
                            >(0, (sum, item) {
                              ...
                              final sub =
                                  (precio is num
                                      ? precio.toDouble()
                                      : double.tryParse(precio.toString()) ??
                                          0) *
                                  (cantidad is num
                                      ? cantidad.toDouble()
                ...
                children: [
                  ...
                  Expanded(
                    child: TabBarView(
                      controller: _tabController!,
                      children: [
                        _buildTablaVentas(true),
                        _buildTablaVentas(false),
                      ],
                    ),
                  ),
                ],
