import 'package:basefundi/desktop/directorio/pedidos/alistar_pedidos_desk.dart';
...
class PedidosDeskScreen extends StatefulWidget {
  ...
  @override
  State<PedidosDeskScreen> createState() => _PedidosDeskScreenState();
}

class _PedidosDeskScreenState extends State<PedidosDeskScreen> {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              _buildBoton('Nuevos Pedidos', Icons.fiber_new, 0),
                          ...
                          Expanded(
                            child: IndexedStack(
                              ...
                              children: const [
                                NuevosPedidosDeskWidget(),
                                AlistarPedidosDeskWidget(),
                                PedidosEnviadosDeskWidget(),
                              ],
                            ),
                          ),
                        ],
