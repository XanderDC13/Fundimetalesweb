...
class ImportarGimnasioScreen extends StatefulWidget {
  const ImportarGimnasioScreen({super.key});

  @override
  State<ImportarGimnasioScreen> createState() => _ImportarGimnasioScreenState();
}

class _ImportarGimnasioScreenState extends State<ImportarGimnasioScreen> {
  bool cargando = false;
  int totalFilas = 0;
  ...
  Future<void> importarCSV() async {
    ...
    try {
      ...
      _manejarError('Error al importar CSV de Gimnasio', e);
    }
  }
  ...
  Future<void> _procesarCSV(String contenido) async {
    ...
    for (int i = 1; i < rowsAsListOfValues.length; i++) {
      ...
      try {
        ...
        print('✅ Gimnasio guardado: $referencia');
      } catch (e) {
    ...
    if (!mounted) return;
    _mostrarMensaje('Gimnasio importado correctamente');
    setState(() => cargando = false);
  }
            ...
            child: Stack(
              children: [
                ...
                const Align(
                  ...
                  child: Text(
                    'Importar CSV - Catálogo de Gimnasio',
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 24,
                    ...
                    cargando
                        ? Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Importando Gimnasio: $filasProcesadas / $totalFilas',
