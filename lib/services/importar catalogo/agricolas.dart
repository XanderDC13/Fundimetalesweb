...
class ImportarAgricolasScreen extends StatefulWidget {
  const ImportarAgricolasScreen({super.key});

  @override
  State<ImportarAgricolasScreen> createState() =>
      _ImportarAgricolasScreenState();
}

class _ImportarAgricolasScreenState extends State<ImportarAgricolasScreen> {
  bool cargando = false;
  int totalFilas = 0;
  ...
  Future<void> importarCSV() async {
    ...
    try {
      ...
      _manejarError('Error al importar CSV de Agrícolas', e);
    }
  }
  ...
  Future<void> _procesarCSV(String contenido) async {
    ...
    for (int i = 1; i < rowsAsListOfValues.length; i++) {
      ...
      try {
        ...
        print('✅ Agrícola guardado: $referencia');
      } catch (e) {
    ...
    if (!mounted) return;
    _mostrarMensaje('Agrícolas importados correctamente');
    setState(() => cargando = false);
  }
            ...
            child: Stack(
              children: [
                ...
                const Align(
                  ...
                  child: Text(
                    'Importar CSV - Catálogo de Agrícolas',
                    style: TextStyle(
                      color: Colors.white,
                      fontSize: 24,
                    ...
                    cargando
                        ? Column(
                          ...
                          children: [
                            ...
                            Text(
                              'Importando Agrícolas: $filasProcesadas / $totalFilas',
