...
class ProformaFundicionScreen extends StatefulWidget {
  @override
  _ProformaFundicionScreenState createState() =>
      _ProformaFundicionScreenState();
}

class _ProformaFundicionScreenState extends State<ProformaFundicionScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFD6EAF8), // Fondo general claro
      body: SafeArea(
        child: Column(
          children: [
            // 📌 ENCABEZADO ESTILO OSCURO
            Transform.translate(
                          ...
                          Expanded(
                            child: SingleChildScrollView(
                              ...
                              child: Column(
                                ...
                                children: [
                                  _buildCompactHeader(), // 📝 tu header interno si tienes
                                  const SizedBox(height: 16),
                                  _buildMobileClienteSection(), // 🧑 cliente
                                  const SizedBox(height: 16),
                                  _buildMobileItemsSection(), // 📦 items
                                  const SizedBox(height: 16),
                                  _buildMobileTotalesSection(), // 💲 totales
